                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" name="email" placeholder="Votre e-mail" :value="old(email)" required autofocus>
                                                <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="login_footer form-group">
                                                <div class="chek-form">
                                                    <div class="custome-checkbox">
                                                        ...
                                                        <label class="form-check-label" for="exampleCheckbox1"><span>Souvenir de moi</span></label>
                                                    </div>
                                                </div>
                                                <a class="text-muted" href="{{ route('password.request') }}">Mot de passe oublié?</a>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-fill-out btn-block hover-up" name="login">Se connectez</button>
                                            </div>
                                        </form>
                                        <div class="flex items-center justify-end mt-4">

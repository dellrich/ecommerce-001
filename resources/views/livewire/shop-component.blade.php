                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> Nous avons trouvé <strong class="text-brand">{{ $products->total() }}</strong>
                                    articles pour vous !</p>
                            </div>
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $pageSize == 50 ? 'active' : '' }}" href="#"
                                                    wire:click.prevent="changePageSize(50)">50</a></li>
                                            <li><a class="{{ $pageSize == 100 ? 'active' : '' }}" href="#"
                                                    wire:click.prevent="changePageSize(100)">100</a></li>
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $orderBy == 'défaut' ? 'active' : '' }}" href="#"
                                                    wire:click.prevent="changeOrderBy('défaut')">défaut</a></li>
                                            <li><a class="{{ $orderBy == 'Prix : Du plus bas au plus haut' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevent="changeOrderBy('Prix : Du plus bas au plus haut')">Prix
                                                    : Du plus bas au plus haut</a></li>
                                            <li><a class="{{ $orderBy == 'Prix : du plus haut au plus bas' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevent="changeOrderBy('Prix : du plus haut au plus bas')">Prix
                                                    : du plus haut au plus bas</a></li>
                                            <li><a class="{{ $orderBy == 'nouveauté' ? 'active' : '' }}" href="#"
                                                    wire:click.prevent="changeOrderBy('nouveauté')">nouveauté</a></li>
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                <a href="{{ route('boutique') }}">{{ $product->category->name }}</a>
                                            </div>
                                            <h2><a
                                            ...
                                            <div class="product-action-1 show">
                                                @if ($witems->contains($product->id))
                                                    <a aria-label="Retirer de la liste de souhaits"
                                                        class="action-btn hover-up wishlisted" href="#"
                                                        wire:click.prevent="removeFromWishlist({{ $product->id }})"><i
                                                            class="fi-rs-heart"></i></a>
                                                @else
                                                    {{-- @if ($product->prix_promo == null) --}}
                                                    <a aria-label="Ajouter la liste de souhaits"
                                                        class="action-btn hover-up" href="w#"
                                                        wire:click.prevent="addToWishlist({{ $product->id }},'{{ $product->name }}', {{ $product->prix_normale }})"><i
                                                            class="fi-rs-heart"></i></a>
                                                    {{-- @else
                                                         <a aria-label="Ajouter à la liste de souhaits" class="action-btn hover-up" href="#" wire:click.prevent="addToWishlist({{ $product->id }},'{{ $product->name }}', {{ $product->prix_promo }})"><i class="fi-rs-heart"></i></a>
                                                    @endif --}}
                                                @endif
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        {{-- <div class="sidebar-widget price_range range mb-30">
                            ...
                            <div class="price-filter">
                                <div class="price-filter-inner">
                                    ...
                                    <div class="price_slider_amount" wire:ignore>
                        ...
                        {{-- <div class="list-group">
                            ...
                            <a href="{{ route('boutique')}}" class="btn btn-sm btn-default"><i class="fi-rs-filter mr-5"></i>
                                Fillter</a>
                        </div> --}}
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                ...
                                @foreach ($categories as $category)
                                    <li class="has-children expanded {{ count($category->subCategories) > 0 }}"> <a
                                            href="#">{{ $category->name }}</a><span>({{ count($category->subCategories) }})</span>
                                        @if (count($category->subCategories) > 0)
                                        <span class="toggle-control">+</span>
                                            <ul class="sub-cate">
                                                @foreach ($category->subCategories as $scategory)
                                                    <li><a
                                                            href="{{ route('product.category', ['slug' => $category->slug, 'sslug' => $scategory->slug]) }}">{{ $scategory->name }}
                                                        </a><span>({{ count($category->subCategories) }})</span>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        @endif
                        ...
                        {{-- <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="{{ route('boutique')}}">Shop Now <i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div> --}}
                    </div>
                </div>

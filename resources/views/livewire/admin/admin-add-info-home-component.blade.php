                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                               <form wire:submit.prevent="addInformation">
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="link" class="form-label">mail</label>
                                        <input type="email" name="link" class="form-control" placeholder="saisir le mail professionnel" wire:model="link" >
                                        @error('link')
                                        <p class="text-danger">{{ $message }}</p>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="file" name="logo_image" class="form-control" placeholder="saisir la quantité" wire:model="logo_image">
                                        @if ($logo_image)
                                            <img src="{{ $logo_image->temporaryUrl()}}" width="120" alt="image du produit">
